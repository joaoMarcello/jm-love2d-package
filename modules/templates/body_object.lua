local GC = _G.Pack.BodyObject

---@class GenericBodyObject : BodyObject
local Object = setmetatable({}, GC)
Object.__index = Object

function Object:new(x, y, w, h, draw_order, update_order, bd_type, reuse_tab)
    local obj = GC:new(x, y, w, h, draw_order, update_order, bd_type, reuse_tab)
